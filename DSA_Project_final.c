...
void findPath(int sourcenumber, int destinationnumber, char *sourcecolor)
{
    ...
    for (int i = 1; i <= count; i++)
    {
        ...
        {   
            ...
            float weight = dist[correct_path[i]];
            printf("\nDistance upto ");
            numToName(correct_path[i]);printf("%.02fkm\n",weight);
            solve_conflict(i);
            continue;
        }
...
int main()
{
    ...
    printf("*********************************************Travel summary*********************************************\n");
    printf("                              TOTAL DISTANCE TRAVELLED = %.02f km\n",weight);
    printf("                              TOTAL FARE               = %0.02f Rs\n",weight*5);
    printf("                        THANKS FOR MAKING PUNE METRO SPECIAL ! HAPPY JOURNEY.....\n");
